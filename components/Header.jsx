          ...
          <div className="colorlib-table-cell js-fullheight">
            <div className="row no-gutters">
              <div className="col-md-12 text-center">
                ...
                <ul>
                  <li className="active">
                    <a className="navig-link" href="#about">
                      <span className="hoverable-rect">About</span>
                    </a>
                  </li>
                  <li>
                    <a className="navig-link" href="#skills">
                      <span className="hoverable-rect">My skills</span>
                    </a>
                  </li>
                  <li>
                    <a className="navig-link" href="#work">
                      <span className="hoverable-rect">Work</span>
                    </a>
                  </li>
                  <li>
                    <a className="navig-link" href="#contact">
            ...
            <div className="popup__container">
              ...
              <div className="popup__content">
                ...
                <p>
                  ...
                  including tracking your interaction with the embedded content
                  if you have an account and are logged in to that website.
                </p>
                <p>
                  How long we retain your data: <br />
                  contact on our website (if any), we only use these
                  informations for contacting purposes and we don't store it in
                  any form of away
                </p>
                <p>
                ...
                <p>
                  Comments: <br />
                  Visitors cannot leave comments on the site, it’s not an
                  option.
                </p>
                <p>
                  Owner: <br />
